  ...
  <div>
    ...
    <div class="bg-base-200 px-4 pt-3 pb-4 rounded-lg shadow">
      <div class="form-control">
        <label class="input-group input-group-md w-full flex gap-2">
      ...
      <div v-if="httpstatus !== 200" class="text-error mt-2">
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div class="bg-base-200 px-4 py-3 rounded-lg shadow flex justify-between items-center">
    ...
    <!-- update -->
    <div class="bg-base-200 p-4 rounded-lg shadow" v-if="roundState['height/round/step']">
          ...
          <div class="flex flex-rows flex-wrap py-6">
            <div class=" w-48 rounded-3xl h-5 text-sm px-2 text-slate-200 leading-5" v-for="(pre, i) in item.prevotes"
              ...
              <span class="flex flex-rows justify-between">
                <span class="truncate text-gray-900 dark:text-white">{{ showName(i, 'nil-Vote') }} </span>
                <span>
    ...
    <!-- alert-info -->
    <div class="text-[#00cfe8] bg-[rgba(0,207,232,0.12)] rounded-lg shadow mt-4 alert-info">
