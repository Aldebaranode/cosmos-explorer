...
<template>
  <div class="my-5 text-center">
    <div v-if="total && limit" class="btn-group flex gap-1 justify-center">
      <button v-for="{ page, color } in pages" :key="page"
        class="btn bg-gray-100 text-gray-500 hover:text-white border-none dark:bg-gray-700 dark:text-white" :class="{
